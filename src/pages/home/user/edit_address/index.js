...
import style from '../../../../assets/css/private/edit_address_index.module.css';
...
class Edit_AddressIndex extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pickerValue: [],
    ...
    componentDidMount() {
        this.setState({
            detailsAddress: this.props.state.user.detailsAddress,
            connector: this.props.state.user.connector,
            mobile: this.props.state.user.mobile,
            defaultState:this.props.state.user.defaultState==='1'?true:false
        })
    }
                ...
                if (this.state.connector === '') {
                    ...
                    if (this.state.mobile === '') {
                        ...
                        if (reg.test(this.state.mobile)) {
                            ...
                            request('http://192.168.125.12:8082/updateaddress', "post", data).then(res => {
                                if (res.code === 200) {
                                    //其实内容有修改的 
                                    Toast.info('修改成功', 2, () => {
        ...
        return (
            <div className={style['edit_address']}>
                <div className={style['head']}>
                    <div className={style['edit_address-head-img']} onClick={this.return.bind(this, 'user/address')}>
                        <img src={require('../../../../assets/images/home/goods/g1.png')} alt="" />
                    </div>
                    <div className={style['edit_address-head-txt']}>
                        修改收货地址
                    </div>
                </div>
                <div className={style['content']}>
                    ...
                    <div className={style['details-address']}>
                        ...
                        <div className={style['item2']}>
                            ...
                            }} defaultValue={this.props.state.user.detailsAddress} />
                        </div>
                    </div>
                    <div className={style['details-address']}>
                        ...
                        <div className={style['item2']}>
                            ...
                            }} defaultValue={this.props.state.user.connector} />
                        </div>
                    </div>
                    <div className={style['details-address']}>
                        ...
                        <div className={style['item2']}>
                            ...
                            }} defaultValue={this.props.state.user.mobile} />
                        </div>
                    </div>
                    ...
                    <div className={style['save']}>
                        <button onClick={this.save.bind(this)}>修改</button>
                    </div>
                </div>
            </div>
        )
